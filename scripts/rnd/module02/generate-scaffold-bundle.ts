// RND: Module 02 Data Lake scaffold artifact generator.

import fs from "node:fs";
import path from "node:path";
import {
  assertModule02ScaffoldBundle,
  buildModule02ScaffoldBundle,
} from "../../../lib/rnd/module02-data-lake/scaffold";
...
async function main() {
  ...
  if (args.outPath) {
    ...
    console.log(`Wrote Module 02 scaffold bundle: ${absolutePath}`);
    return;
  }
