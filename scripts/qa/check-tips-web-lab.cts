...
assert.match(proStudyUi, /테스터의 시작 점수와 2주·4주 후 점수를 비교하세요/);
...
assert.match(proStudyUi, /테스터의 시작 점수와 2주·4주 후 점수를 비교하세요/);
assert.match(proStudyUi, /예시 테스터 8명 자동 입력/);
assert.match(proStudyUi, /입력 결과 CSV 저장/);
...
assert.match(blindTestUi, /비교 기준 추천/);
