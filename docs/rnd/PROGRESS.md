...
- [x] 2026-02-28 implementation-coverage automation: added `tips-implementation-coverage.json` generation and pass-gate linkage in `scripts/rnd/train-all-ai.ts` to verify slide 18~26 핵심 구현 요소 누락 여부를 자동 점검.
