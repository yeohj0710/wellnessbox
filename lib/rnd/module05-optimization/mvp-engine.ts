...
function assertObjectiveWeights(value: RndModule05ObjectiveWeights): void {
...
function buildSignalMap(input: RndModule05OptimizationInput): Map<string, ItemSignal> {
...
function buildBlockedConstraintMap(
...
function buildLimitedIngredientSet(input: RndModule05OptimizationInput): Set<string> {
...
function buildComboId(itemIds: string[]): string {
