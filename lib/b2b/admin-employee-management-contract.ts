export const ADMIN_EMPLOYEE_RECORD_TYPES = [
  "healthSnapshot",
  "surveyResponse",
  "analysisResult",
  "pharmacistNote",
...
export type AdminEmployeeRecordType =
  (typeof ADMIN_EMPLOYEE_RECORD_TYPES)[number];

export type AdminEmployeeCreatePayload = {
  name: string;
  birthDate: string;
  phone: string;
...
export type AdminEmployeePatchPayload = {
  name?: string;
  birthDate?: string;
  phone?: string;
  appUserId?: string | null;
...
export type AdminEmployeeDeletePayload = {
  confirmName: string;
};
...
export type AdminEmployeeListResponse = {
  ok: boolean;
