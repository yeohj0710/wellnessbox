    ...
    <div className="w-full max-w-[640px] mt-8 mb-12 px-8 py-10 bg-white sm:shadow-md sm:rounded-lg">
      ...
      <div className="text-gray-700 leading-relaxed">
        ...
        <p className="mb-6">
          ...
          소분 판매 플랫폼 서비스의 이용 조건 및 절차, 기타 필요한 사항을
          규정함을 목적으로 합니다.
        </p>
        <h2 className="text-lg font-semibold text-gray-800 mb-4">
          제2조 (정의)
        ...
        <ul className="list-disc pl-6 mb-6">
          <li>
            &quot;서비스&quot;란 회사가 제공하는 건강기능식품 소분 판매 및 관련
            온라인 플랫폼 서비스를 말합니다.
          </li>
          <li>
            &quot;이용자&quot;란 본 약관에 따라 서비스를 이용하는 고객을
            말합니다.
          </li>
          <li>
        ...
        <p className="mb-6">
          1. 건강기능식품의 특성상, 제품이 발송된 이후에는 원칙적으로 환불이
          불가능합니다. 단, 제품의 하자 또는 오배송의 경우에는 전액 환불 또는
          교환해 드립니다.
          <br />
        ...
        <ul className="list-disc pl-6 mb-6">
          <li>개봉 또는 사용한 제품</li>
          <li>배송 후 7일이 경과한 제품</li>
          <li>소비자의 부주의로 인해 제품이 손상된 경우</li>
        </ul>
        <p className="mb-6">
          5. 환불 요청이 승인된 경우, 환불은 접수일로부터 영업일 기준 5일 이내에
          처리됩니다.
        </p>
        <h2 className="text-lg font-semibold text-gray-800 mb-4">
          제8조 (기타)
        ...
        <p className="">
          본 약관에서 정하지 않은 사항은 관계법령과 상관례에 따릅니다.
        </p>
      </div>
    </div>
  );
