...
export default function ManageProducts() {
  ...
  return (
    <div className="relative left-1/2 right-1/2 min-h-screen w-screen -translate-x-1/2 bg-[linear-gradient(180deg,#fbfdff_0%,#f3f7fb_100%)]">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-0 h-screen bg-[radial-gradient(circle_at_15%_0%,rgba(125,211,252,0.28),transparent_34%),radial-gradient(circle_at_85%_0%,rgba(191,219,254,0.36),transparent_28%)]"
      />
      <div className="relative mx-auto flex w-full max-w-[1220px] flex-col gap-6 px-4 pb-16 pt-8 sm:px-6 lg:px-8">
