...
export const RULES: Rule[] = [
  ...
  {
    question: "A5",
    eval: (a) => a.A1 === "F" && a.A5 === true,
    weights: { folicAcid: 2, iron: 1, multivitamin: 1 },
  },
  {
    question: "A8",
    eval: (a) => a.A8 === true,
    weights: { milkThistle: 2, coenzymeQ10: 1, vitaminB: 1 },
  },
  {
    question: "A11",
    eval: (a) => (a.A11 ?? 0) === 0,
  ...
  {
    question: "A14_high_plus",
    eval: (a) => a.A14 === "6+",
    weights: { vitaminA: 1, phosphatidylserine: 1 },
  },
  {
    question: "A15_const",
    eval: (a) => a.A15 === "const",
