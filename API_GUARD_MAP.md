...
| Route | Methods | Guards | Session Access | Note | File |
|---|---|---|---|---|---|
| `/api/admin/b2b/employees` | `GET` | - | `none` | - | `app/api/admin/b2b/employees/route.ts` |
| `/api/admin/b2b/employees/[employeeId]` | `GET` | - | `none` | - | `app/api/admin/b2b/employees/[employeeId]/route.ts` |
| `/api/admin/b2b/employees/[employeeId]/analysis` | `GET, POST, PUT` | - | `none` | - | `app/api/admin/b2b/employees/[employeeId]/analysis/route.ts` |
| `/api/admin/b2b/employees/[employeeId]/note` | `GET, PUT` | - | `none` | - | `app/api/admin/b2b/employees/[employeeId]/note/route.ts` |
| `/api/admin/b2b/employees/[employeeId]/report` | `GET, POST` | - | `none` | - | `app/api/admin/b2b/employees/[employeeId]/report/route.ts` |
| `/api/admin/b2b/employees/[employeeId]/survey` | `GET, PUT` | - | `none` | - | `app/api/admin/b2b/employees/[employeeId]/survey/route.ts` |
...
| `/api/admin/b2b/reports/[reportId]/meta` | `PATCH` | - | `none` | - | `app/api/admin/b2b/reports/[reportId]/meta/route.ts` |
| `/api/admin/b2b/reports/[reportId]/validation` | `GET` | - | `none` | - | `app/api/admin/b2b/reports/[reportId]/validation/route.ts` |
| `/api/admin/column/posts` | `GET, POST` | - | `none` | - | `app/api/admin/column/posts/route.ts` |
| `/api/admin/column/posts/[id]` | `DELETE, GET, PATCH` | - | `none` | - | `app/api/admin/column/posts/[id]/route.ts` |
| `/api/admin/column/posts/[id]/publish` | `POST` | - | `none` | - | `app/api/admin/column/posts/[id]/publish/route.ts` |
...
| `/api/b2b/employee/report` | `GET` | - | `none` | - | `app/api/b2b/employee/report/route.ts` |
| `/api/b2b/employee/report/export/pdf` | `GET` | - | `none` | - | `app/api/b2b/employee/report/export/pdf/route.ts` |
| `/api/b2b/employee/session` | `DELETE, GET, POST` | - | `none` | - | `app/api/b2b/employee/session/route.ts` |
...
| `/api/health/nhis/fetch` | `POST` | - | `none` | - | `app/api/health/nhis/fetch/route.ts` |
| `/api/health/nhis/init` | `POST` | - | `none` | - | `app/api/health/nhis/init/route.ts` |
| `/api/health/nhis/sign` | `POST` | - | `none` | - | `app/api/health/nhis/sign/route.ts` |
| `/api/health/nhis/status` | `GET` | - | `none` | - | `app/api/health/nhis/status/route.ts` |
| `/api/health/nhis/unlink` | `POST` | - | `none` | - | `app/api/health/nhis/unlink/route.ts` |
| `/api/home-data` | `GET` | - | `none` | - | `app/api/home-data/route.ts` |
| `/api/internal/warmup` | `GET` | - | `none` | - | `app/api/internal/warmup/route.ts` |
| `/api/logout` | `GET, POST` | - | `none` | Legacy logout compatibility route that clears session cookies. | `app/api/logout/route.ts` |
...
| `/api/admin/model` | `GET, POST` | `requireAdminSession` | `route-auth-import` | - | `app/api/admin/model/route.ts` |
...
| `/api/b2b/employee/sync` | `POST` | `requireNhisSession` | `route-auth-import` | - | `app/api/b2b/employee/sync/route.ts` |
...
| `/api/me/phone-status` | `GET` | `requireUserSession` | `route-auth-import` | - | `app/api/me/phone-status/route.ts` |
...
| `/api/messages/stream/token` | `POST` | `requirePharmSession, requireRiderSession` | `route-auth-import` | - | `app/api/messages/stream/token/route.ts` |
| `/api/pharm-push/subscribe` | `POST` | `requirePharmSession` | `route-auth-import` | - | `app/api/pharm-push/subscribe/route.ts` |
| `/api/push/send` | `POST` | `requireCustomerOrderAccess` | `route-auth-import` | - | `app/api/push/send/route.ts` |
| `/api/push/subscribe` | `POST` | `requireCustomerOrderAccess` | `route-auth-import` | - | `app/api/push/subscribe/route.ts` |
...
| `/api/rider-push/subscribe` | `POST` | `requireRiderSession` | `route-auth-import` | - | `app/api/rider-push/subscribe/route.ts` |
